...
if __name__ == "__main__":
    ...
    #----------------------------------------------------------------------------------------------------------#
    test_interval   = 100
    fps_image_path  = r"D:\yolov7-pytorch-master\img\000001.jpg"
    #-------------------------------------------------------------------------#
    ...
    # dir_origin_path = r"D:\KAIST数据集\重新标注的kaist\kaist_wash_picture_test\visible"
    dir_origin_path =r"D:\KAIST数据集\重新标注的kaist\kaist_wash_picture_test\lwir"
    dir_save_path = "img_out/lwir_conf0.3nms0.3/"
    #-------------------------------------------------------------------------#
