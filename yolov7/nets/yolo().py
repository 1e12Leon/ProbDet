...
from yolov7.utils.attentions import se_block, cbam_block, eca_block, EPSABlock, SEWeightModule

attention_bocks = [se_block, cbam_block, eca_block, EPSABlock]
...
class YoloBody(nn.Module):
    def __init__(self, anchors_mask, num_classes, phi, pretrained=False, phi_attention=4):
        ...
        if phi_attention == 4:
            self.feat1_attention = attention_bocks[phi_attention - 1](512, 256)
            self.feat2_attention = attention_bocks[phi_attention - 1](1024, 512)
