...
if __name__ == '__main__':
    ...
    #   载入数据集，可以使用VOC的xml
    #-------------------------------------------------------------#
    path        = r'E:\pythonProject\object-detection\yolov7-pytorch-master\VOCdevkit\VOC2007\Annotations'
    # path        = r'E:\pythonProject\object-detection\ProbEn-master\VOCdevkit\VOC2007\Annotations'
    ...
    f = open("model_data/yolo_anchors_voc4.txt", 'w')
