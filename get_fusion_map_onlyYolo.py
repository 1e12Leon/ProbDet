...
if __name__ == "__main__":
    ...
    #   结果输出的文件夹，默认为map_out
    # -------------------------------------------------------#
    map_out_path = 'map_out_ProbEn_YOLO1'
    ...
    if map_mode == 0 or map_mode == 1:
        ...
        for image_id in tqdm(image_ids):
            ...
            if map_vis:
                image_rgb.save(os.path.join(map_out_path, "images-optional/rgb/" + image_id + ".jpg"))
                image_T.save(os.path.join(map_out_path, "images-optional/T/" + image_id + ".jpg"))
            ...
            proben.get_map_txt(image_id, class_names, map_out_path, dets_rgb, scores_rgb, dets_T, scores_T)
