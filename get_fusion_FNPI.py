...
if __name__ == "__main__":
    ...
    #   结果输出的文件夹，默认为map_out
    #-------------------------------------------------------#
    FNPI_out_path    = 'FNPI_out/FNPI_out_ProbEn_VOC4'
    ...
    if map_mode == 0 or map_mode == 1:
        ...
        for image_id in tqdm(image_ids):
            ...
            proben.get_map_txt(image_id, class_names, FNPI_out_path, dets_yolo, scores_yolo, dets_centernet, scores_centernet)
